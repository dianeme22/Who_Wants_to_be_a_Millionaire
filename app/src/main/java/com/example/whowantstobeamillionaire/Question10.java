...
public class Question10 extends AppCompatActivity{
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int button) {
                        if (button == DialogInterface.BUTTON_POSITIVE) {
                            ...
                            Toast.makeText(Question10.this,
    ...
    public void goto_next_result(View view) {
        if(!answered)
            return;
        if(!correctAnswer){
            ...
            Intent intent = new Intent(this, results_final.class);
            intent.putExtra("level", 100);
            intent.putExtra("claim", 1000000);
            startActivity(intent);
        }
    }
    ...
    public void prizemoney(View view) {
        Intent intent = new Intent(this, results.class);
        intent.putExtra("level", correctAnswer?100:10);
        intent.putExtra("claim", correctAnswer?1000000:50000);
